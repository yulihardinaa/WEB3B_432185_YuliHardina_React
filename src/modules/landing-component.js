                            ...
                            <Row>
                                <Col span={24}>
                                    <div className="title-container">
                                        ...
                                        <br/>
                                        <span className="text-soft-blue title-big bold">Ni Luh Yuli Hardina Pujastuti</span>
                                    </div>
                                </Col>
                                <Col span={24}>
                                ...
                                <Modal
                                    ...
                                    >
                                    <p className="text-notif">Anda dapat mengirimkan atau bertanya di ni.y.h@mail.ugm.ac.id</p>
